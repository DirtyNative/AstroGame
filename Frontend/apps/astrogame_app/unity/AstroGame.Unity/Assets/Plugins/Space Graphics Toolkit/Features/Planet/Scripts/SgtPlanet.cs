...
namespace SpaceGraphicsToolkit
{
	...
	public class SgtPlanet : MonoBehaviour, IOverridableSharedMaterial
	{
		...
		private void HandleCameraDraw(Camera camera)
		{
			...
			if (finalSharedMaterial != null && finalSharedMaterial.Material != null)
			{
				Graphics.DrawMesh(generatedMesh, transform.localToWorldMatrix, finalSharedMaterial.Material, gameObject.layer, camera, 0, properties);
			}
		}
