...
import '../communications/repositories/built_building_repository.dart' as _i33;
...
import '../executers/build_building_executer.dart' as _i45;
import '../executers/fetch_solar_system_executer.dart' as _i36;
import '../executers/login_executer.dart' as _i37;
...
import '../models/buildings/building_construction.dart' as _i48;
import '../models/players/colonized_stellar_object.dart' as _i35;
import '../providers/authorization_token_provider.dart' as _i11;
import '../providers/building_chain_provider.dart' as _i52;
import '../providers/buildings_provider.dart' as _i51;
import '../providers/constructed_buildings_provider.dart' as _i49;
import '../providers/http_header_provider.dart' as _i10;
import '../providers/player_provider.dart' as _i16;
import '../providers/resource_provider.dart' as _i38;
...
import '../views/buildings/buildings_viewmodel.dart' as _i50;
...
import '../views/login/login_viewmodel.dart' as _i39;
import '../views/menus/colony_viewmodel.dart' as _i34;
import '../views/menus/menu_viewmodel.dart' as _i40;
import '../views/menus/player_colonies_viewmodel.dart' as _i15;
import '../views/menus/resource_viewmodel.dart' as _i43;
...
import '../views/start/start_viewmodel.dart' as _i44;
import 'device_info.dart' as _i54;
import 'services_module.dart' as _i55; // ignore_for_file: unnecessary_lambdas
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i33.BuiltBuildingRepository>(
      () => _i33.BuiltBuildingRepository(get<_i9.Dio>(), get<_i14.Logger>()));
  gh.factoryParam<_i34.ColonyViewModel, _i35.ColonizedStellarObject, dynamic>(
      (colonizedStellarObject, _) => _i34.ColonyViewModel(
          get<_i12.SelectedColonizedStellarObjectProvider>(),
          get<_i28.StellarObjectRepository>(),
          colonizedStellarObject));
  gh.factory<_i36.FetchSolarSystemExecuter>(() => _i36.FetchSolarSystemExecuter(
      get<_i23.DialogHelper>(), get<_i24.SolarSystemRepository>()));
  gh.factory<_i37.LoginExecuter>(() => _i37.LoginExecuter(
      get<_i30.AuthorizationRepository>(),
      get<_i17.PlayerRepository>(),
      get<_i21.ResourceRepository>(),
      get<_i11.AuthorizationTokenProvider>(),
      get<_i16.PlayerProvider>(),
      get<_i38.ResourceProvider>(),
      get<_i23.DialogHelper>(),
      get<_i8.NavigationWrapper>()));
  gh.factory<_i39.LoginViewModel>(() => _i39.LoginViewModel(
      get<_i37.LoginExecuter>(), get<_i8.NavigationWrapper>()));
  ...
  gh.factoryParam<_i41.PerkSelectionViewModel, _i42.AddPlayerSpeciesRequest,
      ...
      (_playerSpecies, _) => _i41.PerkSelectionViewModel(
          ...
          _playerSpecies));
  gh.factory<_i43.ResourceViewModel>(() => _i43.ResourceViewModel(
      get<_i29.StoredResourceRepository>(),
      get<_i38.ResourceProvider>(),
      get<_i20.StoredResourceProvider>()));
  gh.factory<_i44.StartViewModel>(() => _i44.StartViewModel(
      get<_i36.FetchSolarSystemExecuter>(), get<_i7.EventService>()));
  gh.factory<_i45.BuildBuildingExecuter>(() => _i45.BuildBuildingExecuter(
      get<_i23.DialogHelper>(), get<_i32.BuildingRepository>()));
  gh.factoryParam<_i46.BuildingViewModel, _i47.Building,
          _i48.BuildingConstruction>(
      (_building, _buildingConstruction) => _i46.BuildingViewModel(
          get<_i32.BuildingRepository>(),
          get<_i19.ResourceHelper>(),
          get<_i45.BuildBuildingExecuter>(),
          get<_i49.ConstructedBuildingsProvider>(),
          _building,
          _buildingConstruction));
  gh.factory<_i50.BuildingsViewModel>(() => _i50.BuildingsViewModel(
      get<_i51.BuildingsProvider>(),
      get<_i52.BuildingChainProvider>(),
      get<_i12.SelectedColonizedStellarObjectProvider>()));
  gh.factory<_i53.ConstructionsViewModel>(() => _i53.ConstructionsViewModel(
      get<_i52.BuildingChainProvider>(), get<_i28.StellarObjectRepository>()));
  gh.singleton<_i11.AuthorizationTokenProvider>(
      _i11.AuthorizationTokenProvider());
  gh.singletonAsync<_i54.DeviceInfo>(() => _i54.DeviceInfo.instance());
  ...
  gh.singleton<_i38.ResourceProvider>(_i38.ResourceProvider());
  ...
  gh.singleton<_i51.BuildingsProvider>(
      _i51.BuildingsProvider(get<_i32.BuildingRepository>()));
  gh.singleton<_i49.ConstructedBuildingsProvider>(
      _i49.ConstructedBuildingsProvider(get<_i33.BuiltBuildingRepository>()));
  gh.singleton<_i52.BuildingChainProvider>(
      _i52.BuildingChainProvider(get<_i31.BuildingChainRepository>()));
  return get;
}
