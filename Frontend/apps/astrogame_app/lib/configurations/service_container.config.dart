...
import '../communications/hubs/building_hub.dart' as _i68;
...
import '../executers/build_building_executer.dart' as _i79;
import '../executers/fetch_solar_system_executer.dart' as _i46;
import '../executers/login_executer.dart' as _i69;
...
import '../providers/research_study_provider.dart' as _i76;
import '../providers/resource_provider.dart' as _i60;
...
import '../providers/stored_resource_provider.dart' as _i75;
import '../providers/studied_researches_provider.dart' as _i74;
import '../services/event_service.dart' as _i9;
import '../services/hub_service.dart' as _i67;
import '../services/local_storage_service.dart' as _i70;
import '../services/navigation_wrapper.dart' as _i10;
import '../views/building_detail/building_detail_viewmodel.dart' as _i62;
import '../views/building_detail/widgets/resource_viewmodel.dart' as _i54;
import '../views/buildings/buildings_viewmodel.dart' as _i39;
import '../views/buildings/widgets/building_viewmodel.dart' as _i80;
...
import '../views/home/widgets/constructions_viewmodel.dart' as _i65;
import '../views/login/login_viewmodel.dart' as _i71;
...
import '../views/menus/resource_viewmodel.dart' as _i77;
...
import '../views/researches/widgets/research_viewmodel.dart' as _i72;
import '../views/resources/resources_viewmodel.dart' as _i59;
import '../views/resources/widgets/resource_viewmodel.dart' as _i58;
...
import '../views/splash/splash_viewmodel.dart' as _i78;
import '../views/start/start_viewmodel.dart' as _i61;
import 'device_info.dart' as _i82;
import 'services_module.dart' as _i83; // ignore_for_file: unnecessary_lambdas
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factoryParam<_i54.ResourceViewModel, _i55.Resource, _i56.BuildingCost>(
      (_resource, _buildingCost) => _i54.ResourceViewModel(
          get<_i9.EventService>(),
          get<_i57.ResourceSnapshotProvider>(),
          get<_i14.SelectedColonizedStellarObjectProvider>(),
          _resource,
          _buildingCost));
  gh.factoryParam<_i58.ResourceViewModel, _i55.Resource, dynamic>(
      (_resource, _) => _i58.ResourceViewModel(
          get<_i9.EventService>(),
          get<_i57.ResourceSnapshotProvider>(),
          get<_i14.SelectedColonizedStellarObjectProvider>(),
          _resource));
  gh.factory<_i59.ResourcesViewModel>(
      () => _i59.ResourcesViewModel(get<_i60.ResourceProvider>()));
  gh.factory<_i61.StartViewModel>(() => _i61.StartViewModel(
  ...
  gh.factoryParam<_i62.BuildingDetailViewModel, _i63.Building,
      ...
      (building, builtBuilding) => _i62.BuildingDetailViewModel(
          ...
          get<_i60.ResourceProvider>(),
          get<_i32.BuildingImageProvider>(),
          building,
          builtBuilding));
  gh.factory<_i65.ConstructionsViewModel>(() => _i65.ConstructionsViewModel(
      get<_i66.BuildingChainProvider>(), get<_i9.EventService>()));
  gh.factory<_i67.HubService>(() => _i67.HubService(get<_i68.BuildingHub>()));
  gh.factory<_i69.LoginExecuter>(() => _i69.LoginExecuter(
      ...
      get<_i10.NavigationWrapper>(),
      get<_i67.HubService>(),
      get<_i70.LocalStorageService>()));
  gh.factoryParam<_i71.LoginViewModel, String, dynamic>((lastEmail, _) =>
      _i71.LoginViewModel(
          get<_i69.LoginExecuter>(), get<_i10.NavigationWrapper>(), lastEmail));
  gh.factoryParam<_i72.ResearchViewModel, _i73.Research, dynamic>(
      (_research, _) => _i72.ResearchViewModel(
          get<_i10.NavigationWrapper>(),
          get<_i74.StudiedResearchesProvider>(),
          get<_i32.ResearchImageProvider>(),
          get<_i75.StoredResourceProvider>(),
          get<_i76.ResearchStudyProvider>(),
          get<_i9.EventService>(),
          get<_i7.ResourceHelper>(),
          _research));
  gh.factory<_i77.ResourceViewModel>(() => _i77.ResourceViewModel(
      get<_i9.EventService>(),
      get<_i60.ResourceProvider>(),
      get<_i75.StoredResourceProvider>()));
  gh.factory<_i78.SplashViewModel>(() => _i78.SplashViewModel(
      get<_i67.HubService>(),
      get<_i70.LocalStorageService>(),
      get<_i10.NavigationWrapper>(),
      get<_i20.PlayerProvider>(),
      get<_i21.PlayerRepository>(),
      get<_i13.AuthorizationTokenProvider>()));
  gh.factory<_i79.BuildBuildingExecuter>(() => _i79.BuildBuildingExecuter(
      get<_i9.EventService>(),
      get<_i28.DialogHelper>(),
      get<_i38.BuildingRepository>(),
      get<_i66.BuildingChainProvider>(),
      get<_i75.StoredResourceProvider>()));
  gh.factoryParam<_i80.BuildingViewModel, _i63.Building, dynamic>(
      (_building, _) => _i80.BuildingViewModel(
          get<_i10.NavigationWrapper>(),
          get<_i66.BuildingChainProvider>(),
          ...
          get<_i32.BuildingImageProvider>(),
          get<_i75.StoredResourceProvider>(),
          get<_i79.BuildBuildingExecuter>(),
          get<_i9.EventService>(),
          get<_i7.ResourceHelper>(),
          _building));
  gh.singleton<_i13.AuthorizationTokenProvider>(
      _i13.AuthorizationTokenProvider());
  gh.singletonAsync<_i82.DeviceInfo>(() => _i82.DeviceInfo.instance());
  gh.singleton<_i9.EventService>(_i9.EventService());
  gh.singleton<_i70.LocalStorageService>(_i70.LocalStorageService());
  ...
  gh.singleton<_i74.StudiedResearchesProvider>(
      _i74.StudiedResearchesProvider(get<_i35.StudiedResearchRepository>()));
  ...
  gh.singleton<_i81.ConstructedBuildingsProvider>(
      _i81.ConstructedBuildingsProvider(get<_i41.BuiltBuildingRepository>()));
  gh.singleton<_i53.ResearchProvider>(
      _i53.ResearchProvider(get<_i23.ResearchRepository>()));
  gh.singleton<_i76.ResearchStudyProvider>(
      _i76.ResearchStudyProvider(get<_i24.ResearchStudyRepository>()));
  gh.singleton<_i60.ResourceProvider>(
      _i60.ResourceProvider(get<_i25.ResourceRepository>()));
  gh.singleton<_i57.ResourceSnapshotProvider>(
      _i57.ResourceSnapshotProvider(get<_i26.ResourceSnapshotRepository>()));
  gh.singleton<_i75.StoredResourceProvider>(_i75.StoredResourceProvider(
      get<_i9.EventService>(),
      get<_i57.ResourceSnapshotProvider>(),
      get<_i14.SelectedColonizedStellarObjectProvider>()));
  gh.singleton<_i66.BuildingChainProvider>(
      _i66.BuildingChainProvider(get<_i37.BuildingChainRepository>()));
  gh.singleton<_i68.BuildingHub>(_i68.BuildingHub(
      get<_i9.EventService>(),
      get<_i17.ServerConnection>(),
      get<_i12.HttpHeaderProvider>(),
      get<_i66.BuildingChainProvider>(),
...
class _$ServicesModule extends _i83.ServicesModule {}
