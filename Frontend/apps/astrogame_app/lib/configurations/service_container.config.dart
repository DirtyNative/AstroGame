...
import '../models/buildings/building.dart' as _i75;
import '../models/buildings/building_construction.dart' as _i43;
import '../models/buildings/building_cost.dart' as _i52;
import '../models/buildings/built_building.dart' as _i76;
import '../models/players/colonized_stellar_object.dart' as _i41;
import '../models/researches/research.dart' as _i66;
...
import '../providers/building_image_provider.dart' as _i77;
import '../providers/buildings_provider.dart' as _i38;
import '../providers/constructed_buildings_provider.dart' as _i79;
import '../providers/http_header_provider.dart' as _i12;
import '../providers/player_provider.dart' as _i18;
import '../providers/research_image_provider.dart' as _i68;
import '../providers/research_provider.dart' as _i49;
import '../providers/research_study_provider.dart' as _i70;
import '../providers/resource_provider.dart' as _i56;
import '../providers/resource_snapshot_provider.dart' as _i53;
...
import '../providers/studied_researches_provider.dart' as _i67;
import '../services/event_service.dart' as _i9;
import '../services/hub_service.dart' as _i60;
import '../services/local_storage_service.dart' as _i63;
import '../services/navigation_wrapper.dart' as _i10;
import '../views/building_detail/building_detail_viewmodel.dart' as _i74;
import '../views/building_detail/widgets/resource_viewmodel.dart' as _i50;
import '../views/buildings/buildings_viewmodel.dart' as _i37;
import '../views/buildings/widgets/building_viewmodel.dart' as _i78;
...
import '../views/login/login_viewmodel.dart' as _i64;
...
import '../views/menus/resource_viewmodel.dart' as _i71;
...
import '../views/researches/widgets/research_viewmodel.dart' as _i65;
import '../views/resources/resources_viewmodel.dart' as _i55;
import '../views/resources/widgets/resource_viewmodel.dart' as _i54;
...
import '../views/splash/splash_viewmodel.dart' as _i72;
import '../views/start/start_viewmodel.dart' as _i57;
import 'device_info.dart' as _i80;
import 'services_module.dart' as _i81; // ignore_for_file: unnecessary_lambdas
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factoryParam<_i50.ResourceViewModel, _i51.Resource, _i52.BuildingCost>(
      (_resource, _buildingCost) => _i50.ResourceViewModel(
          get<_i9.EventService>(),
          get<_i53.ResourceSnapshotProvider>(),
          get<_i14.SelectedColonizedStellarObjectProvider>(),
          _resource,
          _buildingCost));
  gh.factoryParam<_i54.ResourceViewModel, _i51.Resource, dynamic>(
      (_resource, _) => _i54.ResourceViewModel(
          get<_i9.EventService>(),
          get<_i53.ResourceSnapshotProvider>(),
          get<_i14.SelectedColonizedStellarObjectProvider>(),
          _resource));
  ...
  gh.factory<_i62.LoginExecuter>(() => _i62.LoginExecuter(
      ...
      get<_i10.NavigationWrapper>(),
      get<_i60.HubService>(),
      get<_i63.LocalStorageService>()));
  gh.factoryParam<_i64.LoginViewModel, String, dynamic>((lastEmail, _) =>
      _i64.LoginViewModel(
          get<_i62.LoginExecuter>(), get<_i10.NavigationWrapper>(), lastEmail));
  gh.factoryParam<_i65.ResearchViewModel, _i66.Research, dynamic>(
      (_research, _) => _i65.ResearchViewModel(
          get<_i10.NavigationWrapper>(),
          get<_i67.StudiedResearchesProvider>(),
          get<_i68.ResearchImageProvider>(),
          get<_i69.StoredResourceProvider>(),
          get<_i70.ResearchStudyProvider>(),
          get<_i9.EventService>(),
          get<_i7.ResourceHelper>(),
          _research));
  gh.factory<_i71.ResourceViewModel>(() => _i71.ResourceViewModel(
      get<_i9.EventService>(),
      get<_i56.ResourceProvider>(),
      get<_i69.StoredResourceProvider>()));
  gh.factory<_i72.SplashViewModel>(() => _i72.SplashViewModel(
      get<_i60.HubService>(),
      get<_i63.LocalStorageService>(),
      get<_i10.NavigationWrapper>(),
      get<_i18.PlayerProvider>(),
  ...
  gh.factory<_i73.BuildBuildingExecuter>(() => _i73.BuildBuildingExecuter(
      ...
      get<_i69.StoredResourceProvider>()));
  gh.factoryParam<_i74.BuildingDetailViewModel, _i75.Building,
          _i76.BuiltBuilding>(
      (building, builtBuilding) => _i74.BuildingDetailViewModel(
          get<_i36.BuildingRepository>(),
          get<_i56.ResourceProvider>(),
          get<_i77.BuildingImageProvider>(),
          building,
          builtBuilding));
  gh.factoryParam<_i78.BuildingViewModel, _i75.Building, dynamic>(
      (_building, _) => _i78.BuildingViewModel(
          get<_i10.NavigationWrapper>(),
          get<_i59.BuildingChainProvider>(),
          get<_i79.ConstructedBuildingsProvider>(),
          get<_i14.SelectedColonizedStellarObjectProvider>(),
          get<_i77.BuildingImageProvider>(),
          get<_i69.StoredResourceProvider>(),
  ...
  gh.singletonAsync<_i80.DeviceInfo>(() => _i80.DeviceInfo.instance());
  gh.singleton<_i9.EventService>(_i9.EventService());
  gh.singleton<_i63.LocalStorageService>(_i63.LocalStorageService());
  ...
  gh.singleton<_i67.StudiedResearchesProvider>(
      _i67.StudiedResearchesProvider(get<_i33.StudiedResearchRepository>()));
  gh.singleton<_i38.BuildingsProvider>(
      _i38.BuildingsProvider(get<_i36.BuildingRepository>()));
  gh.singleton<_i79.ConstructedBuildingsProvider>(
      _i79.ConstructedBuildingsProvider(get<_i39.BuiltBuildingRepository>()));
  gh.singleton<_i68.ResearchImageProvider>(
      _i68.ResearchImageProvider(get<_i21.ResearchRepository>()));
  gh.singleton<_i49.ResearchProvider>(
      _i49.ResearchProvider(get<_i21.ResearchRepository>()));
  gh.singleton<_i70.ResearchStudyProvider>(
      _i70.ResearchStudyProvider(get<_i23.ResearchStudyRepository>()));
  gh.singleton<_i56.ResourceProvider>(
      _i56.ResourceProvider(get<_i24.ResourceRepository>()));
  gh.singleton<_i53.ResourceSnapshotProvider>(
      _i53.ResourceSnapshotProvider(get<_i25.ResourceSnapshotRepository>()));
  ...
  gh.singleton<_i61.BuildingHub>(_i61.BuildingHub(
      ...
      get<_i59.BuildingChainProvider>(),
      get<_i79.ConstructedBuildingsProvider>()));
  gh.singleton<_i77.BuildingImageProvider>(
      _i77.BuildingImageProvider(get<_i36.BuildingRepository>()));
  return get;
}

class _$ServicesModule extends _i81.ServicesModule {}
