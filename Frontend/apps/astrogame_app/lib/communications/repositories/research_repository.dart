...
class ResearchRepository {
  ...
  ResearchRepository(Dio dio, this._logger, this._serverConnection, this._httpHeaderProvider) {
  ...
  Future<ServerResponseT<ImageProvider>> getImageAsync(
    ...
    try {
      ...
      return ServerResponseT()
        ..data = NetworkImage(_serverConnection.baseAdress + '/api/v1/research/image/$researchId', headers: _httpHeaderProvider.getHeaders());
    } catch (error) {
      return ServerResponseT()..error = ServerError.withError(error: error);
    }
  }
