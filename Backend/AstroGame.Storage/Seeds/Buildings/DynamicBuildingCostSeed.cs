        ...
        public void Configure(EntityTypeBuilder<DynamicBuildingCost> builder)
        {
            builder.HasData(
                ...
                new DynamicBuildingCost()
                {
                    ...
                    TechnologyId = Guid.Parse("8A0A5DAB-F877-4714-8E6B-1B578F480268"),
                ...
                new DynamicBuildingCost()
                {
                    ...
                    TechnologyId = Guid.Parse("8DDE001B-A19D-43A1-B151-CDE09A85C214"),
                    ResourceId = Guid.Parse("00000000-1111-0000-0000-000000000016"),
                    BaseValue = 250,
                    Multiplier = 1.55,
                },
                ...
                new DynamicBuildingCost()
                {
                    ...
                    TechnologyId = Guid.Parse("20EF5BEB-8D80-4EA1-980A-1B77649B4249"),
                    ResourceId = Guid.Parse("00000000-1111-0000-0000-000000000016"),
                    BaseValue = 250,
                    Multiplier = 1.55,
                },
                ...
                new DynamicBuildingCost()
                {
                    ...
                    TechnologyId = Guid.Parse("81B33A6B-C9A6-446C-BF61-441931A9F2AB"),
                    ResourceId = Guid.Parse("00000000-1111-0000-0000-000000000016"),
                    BaseValue = 250,
                    Multiplier = 1.55,
                },
                ...
                new DynamicBuildingCost()
                {
                    ...
                    TechnologyId = Guid.Parse("7D3B17D6-3084-4725-A259-CFF46FC3A554"),
                    ResourceId = Guid.Parse("00000000-1111-0000-0000-000000000016"),
                    BaseValue = 250,
                    Multiplier = 1.55,
                },
                ...
                new DynamicBuildingCost()
                {
                    ...
                    TechnologyId = Guid.Parse("08F6708B-DD2A-427A-9E49-E24810452421"),
                    ResourceId = Guid.Parse("00000000-1111-0000-0000-000000000016"),
                    BaseValue = 250,
                    Multiplier = 1.55,
                },
                ...
                new DynamicBuildingCost()
                {
                    ...
                    TechnologyId = Guid.Parse("35C9D3C1-BB03-4C2A-B6DD-EB34C0BFCF0D"),
                    ResourceId = Guid.Parse("00000000-1111-0000-0000-000000000016"),
                    BaseValue = 250,
                    Multiplier = 1.55,
                },
                ...
                new DynamicBuildingCost()
                {
                    ...
                    TechnologyId = Guid.Parse("ADAB9B7C-53E7-4F89-AA62-61B8A6D8B60F"),
                    ResourceId = Guid.Parse("00000000-1111-0000-0000-000000000016"),
                    BaseValue = 250,
                    Multiplier = 1.55,
                },
                ...
                new DynamicBuildingCost()
                {
                    ...
                    TechnologyId = Guid.Parse("BDCAE1CC-D8E2-4DD5-97B6-8CDE1162F6EE"),
                    ResourceId = Guid.Parse("00000000-1111-0000-0000-000000000016"),
                    BaseValue = 250,
                    Multiplier = 1.55,
                },
                ...
                new DynamicBuildingCost()
                {
                    ...
                    TechnologyId = Guid.Parse("44517245-CB20-4324-A275-4D8642207AD4"),
                    ResourceId = Guid.Parse("00000000-1111-0000-0000-000000000016"),
                    BaseValue = 500,
                    Multiplier = 1.6,
                },
                ...
                new DynamicBuildingCost()
                {
                    ...
                    TechnologyId = Guid.Parse("E200EF94-6EB9-46C8-BA08-3DD86AC3B373"),
                    ResourceId = Guid.Parse("00000000-1111-0000-0000-000000000016"),
                    BaseValue = 300,
                    Multiplier = 1.4,
                },
                ...
                new DynamicBuildingCost()
                {
                    ...
                    TechnologyId = Guid.Parse("E5C2C36B-3393-4599-B054-77458C7E74E8"),
                    ResourceId = Guid.Parse("00000000-1111-0000-0000-000000000016"),
                    BaseValue = 300,
                    Multiplier = 1.4,
                },
                ...
                new DynamicBuildingCost()
                {
                    ...
                    TechnologyId = Guid.Parse("6D519575-BCFB-49F7-AEF9-15A4B8364B32"),
                    ResourceId = Guid.Parse("00000000-1111-0000-0000-000000000016"),
                    BaseValue = 300,
                    Multiplier = 1.4,
                },
                ...
                new DynamicBuildingCost()
                {
                    ...
                    TechnologyId = Guid.Parse("89B6448B-CA4E-43D4-A8BB-69B6F5C55211"),
                    ResourceId = Guid.Parse("00000000-1111-0000-0000-000000000016"),
                    BaseValue = 300,
                    Multiplier = 1.4,
                },
                ...
                new DynamicBuildingCost()
                {
                    ...
                    TechnologyId = Guid.Parse("B8063D0E-D06E-4B2E-A7E6-4812D7DD5A3E"),
                    ResourceId = Guid.Parse("00000000-1111-0000-0000-000000000016"),
                    BaseValue = 800,
                    Multiplier = 1.3,
                },
                ...
                new DynamicBuildingCost()
                {
                    ...
                    TechnologyId = Guid.Parse("5b2aa6bc-9754-42eb-b519-39edd989f9bb"),
                    ResourceId = Guid.Parse("00000000-1111-0000-0000-000000000016"),
                    BaseValue = 60,
                    Multiplier = 1.5,
                },
                ...
                new DynamicBuildingCost()
                {
                    ...
                    TechnologyId = Guid.Parse("B8D93F41-D6C2-4CE8-9763-840ECB53BF44"),
                    ResourceId = Guid.Parse("00000000-1111-0000-0000-000000000016"),
                    BaseValue = 60,
                    Multiplier = 1.5,
                },
                ...
                new DynamicBuildingCost()
                {
                    ...
                    TechnologyId = Guid.Parse("A0500EB9-8F5C-4FD0-90AF-4BE209939464"),
                    ResourceId = Guid.Parse("00000000-1111-0000-0000-000000000016"),
                    BaseValue = 60,
                    Multiplier = 1.5,
                },
                ...
                new DynamicBuildingCost()
                {
                    ...
                    TechnologyId = Guid.Parse("C8D6228C-4C68-444D-BDF9-BB16279A5EB8"),
                    ResourceId = Guid.Parse("00000000-1111-0000-0000-000000000016"),
                    BaseValue = 60,
                    Multiplier = 1.5,
                },
                ...
                new DynamicBuildingCost()
                {
                    ...
                    TechnologyId = Guid.Parse("4DF104B3-64B6-4843-BA43-4B5B98F08C2B"),
                    ResourceId = Guid.Parse("00000000-1111-0000-0000-000000000016"),
                    BaseValue = 60,
                    Multiplier = 1.5,
                },
                ...
                new DynamicBuildingCost()
                {
                    ...
                    TechnologyId = Guid.Parse("626D4D9B-F90E-4E24-8F84-054E709AFA2A"),
                    ResourceId = Guid.Parse("00000000-1111-0000-0000-000000000016"),
                    BaseValue = 60,
                    Multiplier = 1.5,
                },
                ...
                new DynamicBuildingCost()
                {
                    ...
                    TechnologyId = Guid.Parse("0998D19E-C02F-41E2-B2FD-BA5C6FC7DEF1"),
                    ResourceId = Guid.Parse("00000000-1111-0000-0000-000000000016"),
                    BaseValue = 60,
                    Multiplier = 1.5,
                },
                ...
                new DynamicBuildingCost()
                {
                    ...
                    TechnologyId = Guid.Parse("405A352F-943D-40F7-9E8A-359872D25E84"),
                    ResourceId = Guid.Parse("00000000-1111-0000-0000-000000000016"),
                    BaseValue = 60,
                    Multiplier = 1.5,
                },
                ...
                new DynamicBuildingCost()
                {
                    ...
                    TechnologyId = Guid.Parse("428801F4-4777-4589-9A64-CB97BCEF71CB"),
                    ResourceId = Guid.Parse("00000000-1111-0000-0000-000000000016"),
                    BaseValue = 60,
                    Multiplier = 1.5,
                },
                ...
                new DynamicBuildingCost()
                {
                    ...
                    TechnologyId = Guid.Parse("45168D04-86CB-499C-AEC9-A8255580071E"),
                    ResourceId = Guid.Parse("00000000-1111-0000-0000-000000000016"),
                    BaseValue = 60,
                    Multiplier = 1.5,
                },
                ...
                new DynamicBuildingCost()
                {
                    ...
                    TechnologyId = Guid.Parse("9B09D3F5-FBCA-4148-B6A3-355CE7B75240"),
                    ResourceId = Guid.Parse("00000000-1111-0000-0000-000000000016"),
                    BaseValue = 700,
                    Multiplier = 1.25,
                },
                ...
                new DynamicBuildingCost()
                {
                    ...
                    TechnologyId = Guid.Parse("31B2747D-FF1B-49B1-BF97-782BDB28CBA2"),
                    ResourceId = Guid.Parse("00000000-1111-0000-0000-000000000016"),
                    BaseValue = 60,
                    Multiplier = 1.5,
                },
                ...
                new DynamicBuildingCost()
                {
                    ...
                    TechnologyId = Guid.Parse("A6A8F230-DDE3-464D-9EDD-76CFC9882CBB"),
                    ResourceId = Guid.Parse("00000000-1111-0000-0000-000000000016"),
                    BaseValue = 60,
                    Multiplier = 1.5,
                },
                ...
                new DynamicBuildingCost()
                {
                    ...
                    TechnologyId = Guid.Parse("357F7740-3CA7-4FF8-81C6-9CF22289A709"),
                    ResourceId = Guid.Parse("00000000-1111-0000-0000-000000000016"),
                    BaseValue = 60,
                    Multiplier = 1.5,
                }
