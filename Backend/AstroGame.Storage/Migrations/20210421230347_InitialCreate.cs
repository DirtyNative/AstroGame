    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BuildingConditions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BuildingConditions_Buildings_BuildingId",
                        column: x => x.BuildingId,
                        principalTable: "Buildings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BuildingConditions_Conditions_Id",
                        column: x => x.Id,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NeededConditions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_NeededConditions_Conditions_ConditionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ResearchConditions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ResearchConditions_Conditions_Id",
                        column: x => x.Id,
                        principalTable: "Conditions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ResearchConditions_Researches_ResearchId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BuiltBuildingConditions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BuiltBuildingConditions_BuildingConditions_Id",
                        column: x => x.Id,
                        principalTable: "BuildingConditions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });

            migrationBuilder.CreateTable(
                name: "LevelableBuildingConditions",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false, defaultValueSql: "(newid())"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LevelableBuildingConditions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LevelableBuildingConditions_BuildingConditions_Id",
                        column: x => x.Id,
                        principalTable: "BuildingConditions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                name: "BuildingConstructionConditions",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false, defaultValueSql: "(newid())"),
                    BuildingId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BuildingConstructionConditions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BuildingConstructionConditions_Buildings_BuildingId",
                        column: x => x.BuildingId,
                        principalTable: "Buildings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BuildingConstructionConditions_NeededConditions_Id",
                        column: x => x.Id,
                        principalTable: "NeededConditions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });

            migrationBuilder.CreateTable(
                name: "ResearchStudyConditions",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false, defaultValueSql: "(newid())"),
                    ResearchId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ResearchStudyConditions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ResearchStudyConditions_NeededConditions_Id",
                        column: x => x.Id,
                        principalTable: "NeededConditions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ResearchStudyConditions_Researches_ResearchId",
                        column: x => x.ResearchId,
                        principalTable: "Researches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "LevelableResearchConditions",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false, defaultValueSql: "(newid())"),
                    NeededLevel = table.Column<int>(type: "int", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LevelableResearchConditions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LevelableResearchConditions_ResearchConditions_Id",
                        column: x => x.Id,
                        principalTable: "ResearchConditions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });

            migrationBuilder.CreateTable(
                name: "OneTimeResearchConditions",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false, defaultValueSql: "(newid())")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_OneTimeResearchConditions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OneTimeResearchConditions_ResearchConditions_Id",
                        column: x => x.Id,
                        principalTable: "ResearchConditions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                table: "Conditions",
                column: "Id",
                value: new Guid("73180255-1cae-4f66-bdd6-7f6ba892cafe"));
            ...
            migrationBuilder.InsertData(
                table: "BuildingConditions",
                columns: new[] { "Id", "BuildingId" },
                values: new object[] { new Guid("73180255-1cae-4f66-bdd6-7f6ba892cafe"), new Guid("5b2aa6bc-9754-42eb-b519-39edd989f9bb") });
            ...
            migrationBuilder.InsertData(
                table: "NeededConditions",
                columns: new[] { "Id", "ConditionId" },
                values: new object[] { new Guid("d17fcfed-cc17-4e75-9517-ebd23a531bed"), new Guid("73180255-1cae-4f66-bdd6-7f6ba892cafe") });
            ...
            migrationBuilder.InsertData(
                table: "BuildingConstructionConditions",
                columns: new[] { "Id", "BuildingId" },
                values: new object[] { new Guid("d17fcfed-cc17-4e75-9517-ebd23a531bed"), new Guid("b8d93f41-d6c2-4ce8-9763-840ecb53bf44") });
            ...
            migrationBuilder.InsertData(
                table: "LevelableBuildingConditions",
                columns: new[] { "Id", "NeededLevel" },
                values: new object[] { new Guid("73180255-1cae-4f66-bdd6-7f6ba892cafe"), 6 });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BuildingConditions_BuildingId",
                table: "BuildingConditions",
                column: "BuildingId");

            migrationBuilder.CreateIndex(
                name: "IX_BuildingConstructionConditions_BuildingId",
                table: "BuildingConstructionConditions",
                column: "BuildingId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NeededConditions_ConditionId",
                table: "NeededConditions",
                column: "ConditionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ResearchConditions_ResearchId",
                table: "ResearchConditions",
                column: "ResearchId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ResearchStudyConditions_ResearchId",
                table: "ResearchStudyConditions",
                column: "ResearchId");
