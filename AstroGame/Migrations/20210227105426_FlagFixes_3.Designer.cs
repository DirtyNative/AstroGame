...
namespace AstroGame.Api.Migrations
{
    ...
    [Migration("20210227105426_FlagFixes_3")]
    partial class FlagFixes_3
    {
            ...
            modelBuilder.Entity("AstroGame.Shared.Models.Prefabs.PlanetAtmospherePrefab", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("237fd5fb-0e38-438c-9853-eeec215d290f"),
                        ...
                        new
                        {
                            Id = new Guid("f3c2a6f0-cf02-4924-910c-e3155d903be3"),
                        ...
                        new
                        {
                            Id = new Guid("4ec2899f-8ba6-4bbd-a770-59e2ccb2ab87"),
                        ...
                        new
                        {
                            Id = new Guid("53bd7280-8d81-420c-a6f8-de2b40446777"),
                        ...
                        new
                        {
                            Id = new Guid("d3272ee8-09c5-4b14-ab71-fb0bee1043ef"),
            ...
            modelBuilder.Entity("AstroGame.Shared.Models.Prefabs.PlanetPrefab", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("fda627ac-5127-47c0-a572-059b4b59a307"),
                        ...
                        new
                        {
                            Id = new Guid("5cd152de-18db-4cce-a7e1-9a05917820e9"),
                        ...
                        new
                        {
                            Id = new Guid("6f49bbb3-500f-41cb-9a97-0560a9326211"),
            ...
            modelBuilder.Entity("AstroGame.Shared.Models.Prefabs.StarPrefab", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("69b7b900-b83e-4573-a4a6-af5507112d72"),
                            Name = "Test_Prefab",
                            Offset = "(0.0, 0.0, -1.0)",
